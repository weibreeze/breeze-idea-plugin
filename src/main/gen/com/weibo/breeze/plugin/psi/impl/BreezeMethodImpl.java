...
public class BreezeMethodImpl extends ASTWrapperPsiElement implements BreezeMethod {

  public BreezeMethodImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BreezeParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BreezeParam.class);
  }

  @Override
  public String getReturnType() {
    return BreezePsiImplUtil.getReturnType(this);
  }
