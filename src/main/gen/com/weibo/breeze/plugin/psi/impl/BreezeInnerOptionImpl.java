...
public class BreezeInnerOptionImpl extends ASTWrapperPsiElement implements BreezeInnerOption {

  public BreezeInnerOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BreezeVisitor visitor) {
    visitor.visitInnerOption(this);
  }
